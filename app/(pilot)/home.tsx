...
export default function PilotHome() {
    ...
    useEffect(() => {
        const init = async () => {
            try {
                const currentUser = await getCurrentUser() as unknown as PilotDocument;
                setUser(currentUser);
                ...
                if (academyId) {
                    ...
                    // Fallback: Check if user belongs to an academy team
                ...
                console.error("Error fetching user or academy:", error);
            } finally {
                setLoading(false);
            }
        };
