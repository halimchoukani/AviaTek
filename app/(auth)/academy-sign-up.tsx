...
export default function AcademySignUp() {
  ...
  const nextStep = () => {
    ...
    if (step === 3) {
      if (!adminEmail || !password || !adminName) {
        Alert.alert(
          "Error",
          "Please enter Administrator Name, Email, and Password.",
        );
        return;
      }
    }
  ...
  const renderStep3 = () => (
    <View style={styles.stepContainer}>
      ...
      <Text style={styles.sectionSubtitle}>
        How students and authorities can reach you
      </Text>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerCenter}>
            ...
            <Text style={styles.headerSubtitle}>
              Set up your flight training organization
            </Text>
          </View>
        </View>
            ...
            <View key={s} style={styles.progressStepContainer}>
              ...
              {s < 4 && (
                <View
                  style={[
                    styles.progressLine,
                    step > s && styles.progressLineCompleted,
                  ]}
                />
              )}
            </View>
          ...
          >
            {loading ? (
              ...
              <>
                ...
                {step < 4 && (
                  <Feather name="chevron-right" size={20} color="#020617" />
                )}
                {step === 4 && (
...
const CertOption = ({ title, subtitle, selected, onPress }: any) => (
  ...
  >
    <View style={{ flex: 1 }}>
      <Text style={[styles.certTitle, selected && styles.certTitleSelected]}>
        {title}
      </Text>
